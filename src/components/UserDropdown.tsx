...
const UserDropdown: React.FC = () => {
  return (
    <div className="z-50 my-4 w-60 text-base list-none bg-white rounded-xl divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl">
      <div className="py-3 px-4">
        <span className="block text-sm font-semibold text-gray-900 dark:text-white">Nova User</span>
        <span className="block text-sm text-gray-900 truncate dark:text-white">admin@nova.meme</span>
      </div>
      ...
      <ul className="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
        <li>
          <a href="#" className="block py-2 px-4 text-sm hover:bg-gray-100 rounded-b-xl dark:hover:bg-gray-600 dark:hover:text-white">Sign out</a>
        </li>
      </ul>
    </div>
  );
