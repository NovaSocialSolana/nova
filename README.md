...
<p align="center">
Show who you are from your actions on the blockchain.
</p>
...
- [Nova Roadmap ReadMe](https://docs.appflowy.io/docs/appflowy/roadmap)
- [Nova Public Roadmap](https://github.com/orgs/AppFlowy-IO/projects/5/views/12)
...
Solscan has been our favourite project and knowledge management tool in recent years because of its wide variety of data and functionality. Our team uses it daily, and we are on its paid plan. However, as we all know, Solscan has its limitations. These include weak UI/UX, lack of socialtivity and poor compatibility with mobile devices. Likewise, alternative collaborate workplace management tools also have their own constraints.
...
- To individuals, we would like to offer Solscan's functionality, security, and cross-platform native experience.
- To teams, Nova is dedicated to offering collaboration services to enable you to build your own team of traders. Moreover, you have 100% control of your social image. You can design and showcase achievements made by you or your team your way. 
...
We do not claim to outperform Solscan in terms of functionality and design, at least for now. Besides, our priority doesn't lie in more functionality at the moment. Instead, we would like to cultivate a community to democratize the knowledge and wheels of making complex workplace management tools while enabling people and businesses to create beautiful things on their own by equipping them with a versatile toolbox of building blocks.
